...
export const getSubmitStatus = (id, jobName) => ({
...
export const getSubmitStatusFulfilled = (submitStatusResponse, jobName) => ({
...
export const submitStatusReceived = (id, jobName) => ({
...
export const asyncSubmitApplications = (buildId, fromArtifact) => ({
