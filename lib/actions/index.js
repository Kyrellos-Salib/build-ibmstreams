...
export const submitFromBundleWithParams = (submitBundleId, submitParameters) => ({
  type: actions.SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES_WITH_PARAMS,
  submitBundleId,
  submitParameters
});
...
export const submitApplications = (buildId, fromArtifact, identifier) => ({
...
export const asyncSubmitApplications = (buildId, fromArtifact, identifier) => ({
  type: actions.ASYNC_SUBMIT_APPLICATIONS,
  buildId,
  fromArtifact,
  identifier
export const submitApplications = (buildId, fromArtifact, submissionTimeValues) => ({
  type: actions.SUBMIT_APPLICATIONS,
  buildId,
  fromArtifact,
...
export const getSubmissionTimeParamsFromAdl = (buildId, fromArtifact) => ({
...
export const submitApplicationsFromBundleFilesAsync = (bundles) => ({
  type: actions.SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES_ASYNC,
  bundles
});
...
export const actions = {
  ...
  ASYNC_SUBMIT_APPLICATIONS: 'ASYNC_SUBMIT_APPLICATIONS',
  SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES: 'SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES',
  SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES_ASYNC: 'SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES_ASYNC',
  SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES_WITH_PARAMS: 'SUBMIT_APPLICATIONS_FROM_BUNDLE_FILES_WITH_PARAMS',
