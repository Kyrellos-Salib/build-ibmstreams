...
export default {
    ...
    this.subscriptions.add(
      atom.contextMenu.add({
        ...
        'atom-text-editor': [
          ...
          {
            label: 'IBM Streams',
            shouldDisplay: self.shouldShowMenuE,
            beforeGroupContaining: ['tree-view:open-selected-entry-up'],
            submenu: [
              {
                label: 'Build',
                command: 'spl-build:build-download',
                shouldDisplay: self.shouldShowMenuSplE
              },
              {
                label: 'Build and submit job',
                command: 'spl-build:build-submit',
              ...
              },
              {
                label: 'Build',
                command: 'spl-build:build-make-download',
                shouldDisplay: self.shouldShowMenuMakeE
              },
              {
                label: 'Build and submit job(s)',
                command: 'spl-build:build-make-submit',
              ...
              },
              {
                label: 'Submit job',
                command: 'spl-build:submit',
                shouldDisplay: self.shouldShowMenuSubmitE
              },
              {
                label: 'Open IBM Cloud Private for Data dashboard',
                command: 'spl-build:open-icp4d-dashboard',
                shouldDisplay: self.shouldShowMenuV5E.bind(self)
              },
              {
                label: 'Open IBM Cloud dashboard',
                command: 'spl-build:open-IBM-cloud-dashboard',
                shouldDisplay: self.shouldShowMenuV4E.bind(self)
              },
              {
                label: 'Open IBM Streams Console',
                command: 'spl-build:open-streams-console',
                shouldDisplay: self.shouldShowMenuE.bind(self)
              }
            ]
          },
          {
  ...
  shouldShowMenuV4E() {
    this.shouldShowMenuE = this.shouldShowMenuE.bind(this);
    return this.shouldShowMenuE() && this.apiVersion === CONF_API_VERSION_V4;
  },
  ...
  shouldShowMenuV5E(event) {
    this.shouldShowMenuE = this.shouldShowMenuE.bind(this);
    return this.shouldShowMenuE() && this.apiVersion === CONF_API_VERSION_V5;
  },
