...
export default {
	...
	activate(state) {
      ...
      atom.contextMenu.add({
      	"atom-workspace": [
      		...
      		{
      			label: "Run Make for IBM Streaming Analytics",
      			command: "spl-build:build-make",
      			shouldDisplay: self.shouldShowContextMenuMake
      		},
      		{
      			label: "Run Make for IBM Streaming Analytics and submit job",
      			command: "spl-build:build-make-submit",
      			shouldDisplay: self.shouldShowContextMenuMake
      		},
      		{
      			label: "Run Make for IBM Streaming Analytics and download bundles",
	...
	shouldShowContextMenuMake(event) {
