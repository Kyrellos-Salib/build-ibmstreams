...
export default {
  ...
  checkAtomIdeUi() {
    ...
    const notificationOptions = {
      ...addedButtons,
      dismissable: true,
      description: 'Using build-ibmstreams without atom-ide-ui installed will cause an error\nPlease reload atom after the installation is complete'
    };
