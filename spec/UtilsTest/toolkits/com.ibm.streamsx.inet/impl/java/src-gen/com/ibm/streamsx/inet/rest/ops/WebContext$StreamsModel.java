...
@com.ibm.streams.operator.model.PrimitiveOperator(namespace="com.ibm.streamsx.inet.rest", description="Embeds a Jetty web server to provide HTTP or HTTPS REST access to files defined by the `context` and `contextResourceBase` parameters.\n**Limitations**:\n * By default no security access is provided to the data, HTTPS must be explicitly configured.")
@com.ibm.streams.operator.model.Icons(location32="icons/WebContext_32.gif", location16="icons/WebContext_16.gif")
@com.ibm.streams.operator.internal.model.ShadowClass("com.ibm.streamsx.inet.rest.ops.WebContext")
@javax.annotation.Generated("com.ibm.streams.operator.internal.model.processors.ShadowClassGenerator")
public class WebContext$StreamsModel extends com.ibm.streams.operator.AbstractOperator
 {
