...
sub main::generate($$) {
   ...
   print "\n";
   print 'private:', "\n";
   print '  //generate and sent output statistics tuple', "\n";
   print '  void generateOutTuple(bool success, IPort0Type const & iport$0);', "\n";
   print '  com::ibm::streamsx::inet::ftp::FTPPutFileWrapper * writer;', "\n";
   print '  ', "\n";
